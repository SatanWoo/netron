    ...
    _buildExtraInfo(metadata, opParameterObject, opParameterName,  net) {
        ...
        switch (opParameterName) {
            ...
            case 'InnerProduct': {
                ...
                this._inputs.push(new mnn.Parameter("weight", true, [
                    new mnn.Argument('', null, new mnn.Tensor(new mnn.TensorType("Float32", new mnn.TensorShape([outputCount, inputCount]))))
                ]));
                this._inputs.push(new mnn.Parameter("bias", true, [
                    new mnn.Argument('', null, new mnn.Tensor(new mnn.TensorType("Float32", new mnn.TensorShape([outputCount]))))
                ]));
            ...
            case 'Scale': {
                var scaleDataCount = opParameterObject.scaleDataLength();
                this._inputs.push(new mnn.Parameter("scale", true, [
                    new mnn.Argument('', null, new mnn.Tensor(new mnn.TensorType("Float32", new mnn.TensorShape([scaleDataCount]))))
                ]));
                this._inputs.push(new mnn.Parameter("bias", true, [
                    new mnn.Argument('', null, new mnn.Tensor(new mnn.TensorType("Float32", new mnn.TensorShape([scaleDataCount]))))
                ]));
            ...
            case 'BatchNorm': {
                ...
                this._inputs.push(new mnn.Parameter("slope", true, [
                    new mnn.Argument('', null, new mnn.Tensor(new mnn.TensorType("Float32", new mnn.TensorShape([channels]))))
                ]));
                this._inputs.push(new mnn.Parameter("mean", true, [
                    new mnn.Argument('', null, new mnn.Tensor(new mnn.TensorType("Float32", new mnn.TensorShape([channels]))))
                ]));
                this._inputs.push(new mnn.Parameter("variance", true, [
                    new mnn.Argument('', null, new mnn.Tensor(new mnn.TensorType("Float32", new mnn.TensorShape([channels]))))
                ]));
                this._inputs.push(new mnn.Parameter("bias", true, [
                    new mnn.Argument('', null, new mnn.Tensor(new mnn.TensorType("Float32", new mnn.TensorShape([channels]))))
            ...
            case 'PRelu':{
                ...
                this._inputs.push(new mnn.Parameter("slope", true, [
                    new mnn.Argument('', null, new mnn.Tensor(new mnn.TensorType("Float32", new mnn.TensorShape([slopeCount]))))
                ]));
                break;
            }
            ...
            case 'Normalize':{
                ...
                this._inputs.push(new mnn.Parameter("scale", true, [
                    new mnn.Argument('', null, new mnn.Tensor(new mnn.TensorType("Float32", new mnn.TensorShape([scaleLength]))))
                ]));
                break;
            }
        }
